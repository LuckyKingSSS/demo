...
void main() 
{
    vec4 tuneColor = texture2D(mSample0, textureCoord);
    ...
    if(SumFlag > 0)
    {
        vec4 blendColor = texture2D(mSample2, textureCoord);
    ...
    gl_FragColor = vec4(tuneColor.r, tuneColor.g, tuneColor.b, 1.0);
}
