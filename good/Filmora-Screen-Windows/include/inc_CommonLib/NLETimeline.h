...
public:
	...
	void SetFreezeEnable(bool bEnable);
	bool IsFreezeEnable();
	void SetFreezeFrame(int pos, int len);
	//void SetFreezePosition(int pos);	//相对于原始src的偏移
	//int GetFreezePosition();
	//void SetFreezeLen(int len);			//定帧的长度
	//int GetFreezeLen();
protected:
